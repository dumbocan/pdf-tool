...
- [ ] `WU-5A2-RED` Add packaged-path/integrity/no-PATH/resource tests before build changes. <!-- sdd-owner: implementation -->
- [ ] `WU-5A2-GREEN` Declare the minimum pinned `externalBin`/resources using installed Tauri schema. <!-- sdd-owner: implementation -->
- [ ] `WU-5A2-TRIANGULATE` Build on the first matrix target and prove local extraction with the packaged engine. <!-- sdd-owner: implementation -->
