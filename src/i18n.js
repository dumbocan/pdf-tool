...
const STRINGS = {
  es: {
    ...
    config_sep: "---------------------------",
    ask_ai: "¿Querés que las facturas desconocidas se lean con IA? (s/N): ",
    no_ai: "OK, sin IA. Las facturas de proveedores conocidos se leen igual.",
    ask_key: "Pegá tu clave de MiniMax (https://platform.minimax.io): ",
    no_key: "Sin clave — lo dejamos sin IA por ahora. Podés volver con: pdf-tool config",
    ask_model: "Modelo (Enter = {model}): ",
    ...
    ask_pattern: "Formato del nombre. Podés usar: {fecha} {proveedor} {palabra} {numero}\nEjemplo: {fecha}_{proveedor}_{palabra} → 2026-08-01_proveedor_articulo.pdf\n(Enter para dejar: {default}): ",
  ...
  en: {
    ...
    config_sep: "---------------------------",
    ask_ai: "Do you want unknown invoices read with AI? (y/N): ",
    no_ai: "OK, no AI. Invoices from known vendors are still read.",
    ask_key: "Paste your MiniMax API key (https://platform.minimax.io): ",
    no_key: "No key — leaving AI off for now. You can come back with: pdf-tool config",
    ask_model: "Model (Enter = {model}): ",
    ...
    ask_pattern: "Name format. You can use: {fecha} {proveedor} {palabra} {numero}\nExample: {fecha}_{proveedor}_{palabra} → 2026-08-01_vendor_article.pdf\n(Enter to keep: {default}): ",
