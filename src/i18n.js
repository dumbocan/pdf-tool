...
const STRINGS = {
  es: {
    ...
    pattern_pick: "Elegí el formato del nombre:",
    pattern_prompt: "Número (Enter = el actual): ",
    pattern_other: "Otro (escribo el formato)",
    pattern_current: "el actual",
    ask_pattern: "Formato del nombre (Enter = {default}):\n  {fecha} = fecha · {proveedor} = proveedor · {palabra} = palabra clave · {numero} = número\n  Ejemplo: 2026-08-01_supermercado_compra-semanal.pdf\n",
  ...
  en: {
    ...
    pattern_pick: "Pick the name format:",
    pattern_prompt: "Number (Enter = current): ",
    pattern_other: "Other (type the format)",
    pattern_current: "current",
    ask_pattern: "Name format (Enter = {default}):\n  {fecha} = date · {proveedor} = vendor · {palabra} = keyword · {numero} = number\n  Example: 2026-08-01_supermercado_compra-semanal.pdf\n",
